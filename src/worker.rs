...
impl MapDrawerInterface {
    ...
    pub fn set_state_fill_style(&mut self, state: i32, fill_style: String) {
        // console::log_1(&format!("Setting style {} for state {}", fill_style, state).into());
    ...
    pub fn parse_svg(&mut self, svg_content: &str) {
        ...
        console::log_1(&format!("Dynamic shapes: {:?}", self.dynamic_shapes).into());
    }
    ...
    pub fn draw_svg_with_x_y(
        ...
        // ctx.clear_rect(0.0, 0.0, self.view_box.w, self.view_box.h);
